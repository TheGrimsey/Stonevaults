...
public class PillagerDungeonStructure extends StructureFeature<StructurePoolFeatureConfig> {
    public static final Identifier START_POOL = new Identifier(Stonevaults.MODID, "startpool_pillager_dungeon");
    public static Identifier START_POOL_LONG = new Identifier(Stonevaults.MODID, "startpool_pillager_dungeon_long");

    public PillagerDungeonStructure(Codec<StructurePoolFeatureConfig> codec) {
        super(codec, PillagerDungeonStructure::createPiecesGenerator);
    }
